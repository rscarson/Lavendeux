import { JavascriptFormatter } from '../index';
...
describe('JavascriptFormatter', () => {
	...
	describe('Values', () => {
		it('recognizes radix values', () => {
			const output = javascriptFormatter.format('0x5\n 0777\n 0b11\n 0o7\n0X5');
		...
		it('recognizes string values', () => {
			const output = javascriptFormatter.format('"test"\n\'test1\'\n"test2\\""\n\'test3\\\'\'');
			expect(output).toMatch(/>"test"<\//);
		...
		it('recognizes numerical values', () => {
			const output = javascriptFormatter.format('5\n5.56\n.2e+3\n¥1,000.00\n5.6e+7\n.6E7\n.2e-3\n.6');
	...
	describe('Syntax', () => {
		it('recognizes functions', () => {
			const output = javascriptFormatter.format('foo1+bar1(2, 2)+bar2()+bar3(2)+foo2');
